---
title: "Walkthrough: Text classification in open learning resourses"
output: 
  html_document:
    toc: true
    toc_depth: 3
...
step_tokenfilter() to only keep the 1000 most frequent tokens, to avoid
creating too many variables in our model. To finish, we use step_tfidf()
to compute tf-idf.
...
for each class. The function conf_mat_resampled() computes a separate
...
This is the code for building a SVM model:
...
Replace the naive Bayesmodel with a SVM model and compare the results
